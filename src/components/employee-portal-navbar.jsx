...
export function EmployeePortalNavbar({ view, setView, currentUser, onLogout }) {
  ...
  const mobileMenu = (
    <Sheet open={menuOpen} onOpenChange={setMenuOpen}>
      <SheetTrigger className="inline-flex size-9 items-center justify-center rounded-lg border bg-background shadow-xs transition-colors hover:bg-accent lg:hidden" aria-label="Abrir menu">
