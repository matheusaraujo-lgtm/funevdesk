  ...
  return <div className="space-y-5 pb-6">
    ...
    <Card className="overflow-hidden rounded-2xl border-0 py-0 shadow-none ring-1 ring-foreground/10">
      ...
      <div className="overflow-x-auto">
        ...
        <>
        <Table className="hidden min-w-[904px] table-fixed md:table"><TableHeader><TableRow className="bg-muted/10"><TableHead className="w-10 px-3"><Checkbox aria-label="Selecionar todos" checked={allPageSelected} onCheckedChange={togglePage} disabled={!canBulk} /></TableHead><TableHead className="w-[58px]">ID</TableHead><TableHead>Título</TableHead><TableHead className="w-[168px]">Usuário</TableHead><TableHead className="w-[128px]">Responsável</TableHead><TableHead className="w-[156px]">Situação</TableHead><TableHead className="w-[112px]">SLA</TableHead><TableHead className="w-[96px]">Prioridade</TableHead><TableHead className="w-[80px]">Atualizado</TableHead><TableHead className="w-9" /></TableRow></TableHeader>
